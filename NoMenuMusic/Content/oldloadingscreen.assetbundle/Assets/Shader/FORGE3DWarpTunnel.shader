			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.xy = u_xlat0.xx * vec2(_U_TileAnimFactor, _V_TileAnimFactor) + vs_TEXCOORD0.xy;
					    u_xlat0.xy = u_xlat0.xy * _color_ST.xy + _color_ST.zw;
					    u_xlat0 = texture(_color, u_xlat0.xy);
					    SV_Target0.xyz = u_xlat0.xyz * _node_6523.xyz;
